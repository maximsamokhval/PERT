...
# Import Base and all models so Alembic can detect table changes via autogenerate.
# The models must be imported before target_metadata is set.
...
def run_migrations_offline() -> None:
    ...
    No database connection is required — SQL is written to a script.
    """
